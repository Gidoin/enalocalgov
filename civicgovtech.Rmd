...
class:center, middle, inverse
## Open data in local gov

---
## Beyond national OD platform

South Africa Data Portal is SA **national** Open data platform but it's not the only website that publishes available public datasets.
...
---
## Datafirst : Uni of Cape Town

.reduite2[.center[![](img/datafirst.png)]]
.footnote[[Datafirst platform](https://www.datafirst.uct.ac.za/dataportal/index.php/catalog/central#_r=&collection=&country=&dtype=&from=1947&page=1&ps=&sk=&sort_by=nation&sort_order=&to=2019&topic=&view=s&vk=)]
...
More and more mobile applications are currently developed in order to foster public participation in local governments by collecting the opinions and preferences of local citizens. For instance **Stig** :
...
And one of your 2016-2018 NAP commitment : ".red[**Open Budgeting**]"

.center[<img src= "./img/ogpsa1.png" height="400" />]
...
Let's meet at 10am in "Les halles civiques" to discover the French Civic tech ecosystem
