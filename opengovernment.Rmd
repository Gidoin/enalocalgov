...
subtitle: "Local governance, smart cities and open government"
author: "Timothée Gidoin"
date: "l'Ena, Winter School 2019 `r Sys.Date()`"
output:
...
params:
  event: Winter School 2019 - "Open Government"
...
`r paste0("<div class='my-footer'><span>", params$event, "</span> <center><div class=logo><img src='https://fr.wikipedia.org/wiki/Fichier:Logo_de_l%27%C3%89cole_nationale_d%27administration_(ENA).svg' width='100px'></center></span></div>")`
